Pod::Spec.new do |s|
  ...
  s.license             = { :type => 'MIT'}
  s.authors             = { 'vk.team' => 'digital-gov-cert-library-ios@vk.team' } #TODO: - fix later
  s.platform            = :ios, '12.4'
  s.cocoapods_version   = '>= 1.10.0'
  s.source              = { :git => 'git@github.com:Dmitry-Dmitriev/DigitalGovCertLibrary.git', :tag => s.version } #TODO: - fix source later
